...
describe CareerReceivingStat do 
  ...
  describe "#calculate_yards_per_game" do
    it "should calculate yards per game rounded to 1 decimal point" do
      ...
      expect(receiving.send(:calculate_yards_per_game)).to eq(114.6)
    end
    ...
    it "should return 0 if games played and receiving yards are both equal to 0" do
      ...
      expect(receiving.send(:calculate_yards_per_game)).to eq(0)
    end
  ...
  describe "#calculate_yards_per_reception" do
    it "should calculate yards per reception rounded to 1 decimal point" do
      ...
      expect(receiving.send(:calculate_yards_per_reception)).to eq(13.5)
    end
    ...
    it "should return 0 if receptions and receiving yards are both equal to 0" do
      ...
      expect(receiving.send(:calculate_yards_per_reception)).to eq(0)
    end
